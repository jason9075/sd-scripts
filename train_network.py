...
def train(args):
    ...
    if args.max_train_epochs is not None:
        ...
        if is_main_process:
            print(f"override steps. steps for {args.max_train_epochs} epochs is")
    ...
    metadata = {
        "session_id": session_id,  # random integer indicating which group of epochs the model came from
        "output_name": args.output_name,
        "learning_rate": args.learning_rate,
        "network_module": args.network_module,
        "v2": bool(args.v2),
        "seed": args.seed,
        "training_comment": args.training_comment,  # will not be updated after training
    ...
    if accelerator.is_main_process:
        ...
        # log parameter
        accelerator.log({"network_dim": args.network_dim})
        accelerator.log({"network_alpha": args.network_alpha})
        accelerator.log({"unet_lr": args.unet_lr})
        accelerator.log({"text_encoder_lr": args.text_encoder_lr})
        accelerator.log({"max_train_steps": args.max_train_steps})
        accelerator.log({"lr_scheduler": args.lr_scheduler})
        accelerator.log({"resolution": args.resolution})
        accelerator.log({"seed": args.seed})
